...
def create_person(person: Person = Body(...)):
	...
	- Request body parameter:
		- **person: Person** -> A person model with first_name, last_name, age, haircolor and marital status.
	
	Returns a person model with first_name, last_name, age, hair color and marital status.
	"""
	return person
